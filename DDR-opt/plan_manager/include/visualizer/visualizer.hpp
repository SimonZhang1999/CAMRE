...
class Visualizer
{
  ...
  public:
    ...
    Visualizer(ros::NodeHandle nh){
      ...
      kinoastarPubPCL = nh_.advertise<sensor_msgs::PointCloud2>(robot_ns + "/visualizer/kinoastarPathPCL",10);
      kinoastarPubPath = nh_.advertise<nav_msgs::Path>(robot_ns + "/visualizer/kinoastarPath",10);
      finalnodePubMarker = nh_.advertise<visualization_msgs::Marker>(robot_ns + "/visualizer/finalnode",10);
      mincoPathPath = nh_.advertise<nav_msgs::Path>(robot_ns + "/visualizer/mincoPath",10);
      mincoPointMarker = nh_.advertise<visualization_msgs::Marker>(robot_ns + "/visualizer/mincoPoint",10);
